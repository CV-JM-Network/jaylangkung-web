          ...
          {supportTiers.map((tier, index) => {
            ...
            return (
              <ScrollReveal key={index} direction='up' delay={index * 150}>
                <Card
                  className={`relative h-full transition-all duration-300 bg-white hover:-translate-y-2 hover:shadow-xl ${
        ...
        <div className='mt-16'>
          ...
          <div className='mt-8 grid gap-6 md:grid-cols-3'>
            {additionalServices.map((service, index) => {
              ...
              return (
                <ScrollReveal key={index} direction='up' delay={index * 150}>
                  <Card className='transition-all duration-300 bg-white hover:shadow-lg h-full'>
