      ...
      <div className="container mx-auto px-4">
        <div className="grid items-center gap-8 lg:grid-cols-2">
          <div className="space-y-6">
            <h1 className="text-4xl font-bold leading-tight lg:text-6xl">Merevolusi Komunikasi Digital</h1>
            <p className="text-lg opacity-90 lg:text-xl">
              Startup teknologi terkemuka yang menyediakan solusi API WhatsApp mutakhir, layanan internet kecepatan
              tinggi, dan solusi jaringan perusahaan
            </p>
